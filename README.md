...
On modifie notre code précédemment fait pour l'adapter aux nouvelles contrainte nottement la posibilité de modifier la fréquence du chenillard avec le paramètre du module.
